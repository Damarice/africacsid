  ...
  return (
    <section className="py-12 md:py-16 bg-primary text-white relative overflow-hidden">
      ...
      <div ref={ref} className="container-custom text-center relative z-10">
        <h2 className={`text-2xl md:text-4xl font-bold mb-4 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700`}>
          Join Us in Creating Change
        </h2>
        <p className={`text-base md:text-lg mb-6 max-w-3xl mx-auto ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'} transition-all duration-700 delay-200`}>
